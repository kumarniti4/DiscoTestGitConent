...
<!-- disco-toc-start -->
- Setup phase
  - [Setup SAP Business Technology Platform](../mission/01-SetupSAPBusinessTechnologyPlatform) <!-- [begin-disco-metadata] {"label": ["xyz","abc"], "name": "Custom name"} [end-disco-metadata] -->
